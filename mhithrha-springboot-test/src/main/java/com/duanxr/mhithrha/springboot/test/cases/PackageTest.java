...
public class PackageTest {
  ...
  public void testPackageClass() {
    String code = """
        ...
        """;
    String className = "com.duanxr.mhithrha.springboot.test.runtime.PackageTestClass1";
    try {
  ...
  public void testPackageClassWithoutName() {
    String code = """
        package   com.
                    duanxr.
                    mhithrha.springboot.test.runtime  ;
        import java.io.ByteArrayInputStream;
        import java.io.InputStream;
        import java.nio.charset.StandardCharsets;
        import java.util.function.Function;
        ...
        """;
    String className = "com.duanxr.mhithrha.springboot.test.runtime.PackageTestClass2";
    try {
  ...
  public void testPackageAccessClassFromAnotherClassLoader() {
    ...
    String code = """
        ...
        import com.duanxr.mhithrha.springboot.test.runtime.PackageTestClass2;
        import java.io.ByteArrayInputStream;
        import java.io.InputStream;
        import java.nio.charset.StandardCharsets;
        import java.util.function.Function;
        ...
        """;
    String className = "com.duanxr.mhithrha.springboot.test.component.PackageTestClass3";
    try {
      Class<?> compiledClass = compiler.compile(JavaSourceCode.of(className, code));
      Assert.assertEquals(compiledClass.getName(), className);
      Function<String, InputStream> object = (Function<String, InputStream>) compiledClass.getConstructor()
  ...
  public void testPackageAccessCompiledClass() {
    String code0 = """
        package com.duanxr.mhithrha.springboot.test.component;
        import com.duanxr.mhithrha.springboot.test.component.CustomClass;
        import java.util.function.Function;
        ...
        """;
    String className0 = "com.duanxr.mhithrha.springboot.test.component.PackageTestClass4";
    try {
    ...
    String code1 = """
        ...
        """;
    String className1 = "com.duanxr.mhithrha.springboot.test.component.PackageTestClass5";
    try {
      ...
      Assert.assertEquals(object.apply(className1),
          "custom:com.duanxr.mhithrha.springboot.test.component.PackageTestClass5");
    } catch (Exception e) {
      e.printStackTrace();
      fail();
    }
  ...
  /**
   * add -Dfile.encoding=UTF-8  for fat jar
   */
  public void testNonAsciiPackageClass() {
    String code = """
        ...
        """;
    String className = "com.duanxr.mhithrha.springboot.test.runtime.测试包.包测试类6";
    try {
      Class<?> compiledClass = compiler.compile(JavaSourceCode.of(className, code));
      Assert.assertEquals(compiledClass.getName(), className);
      Function<String, InputStream> object = (Function<String, InputStream>) compiledClass.getConstructor()
  ...
  public void testNonAsciiPackageClassWithoutName() {
    String code = """
        ...
        """;
    String className = "com.duanxr.mhithrha.springboot.test.runtime.测试包.包测试类7";
    try {
      Class<?> compiledClass = compiler.compile(JavaSourceCode.of(code));
      Assert.assertEquals(compiledClass.getName(), className);
      Function<String, InputStream> object = (Function<String, InputStream>) compiledClass.getConstructor()
