...
public class BunchCompileTest {
  ...
  public void testBunchCompile() {
    String code = """
        ...
        """;
    String className = "com.duanxr.mhithrha.test.runtime.BunchCompileTest%s";
    try {
      final int count = 100;
  ...
  public void testBunchCompileWithDependency() {
    String code0 = """
        ...
        """;
    String className0 = "com.duanxr.mhithrha.test.runtime.BunchCompileWithDependencyTest0";
    String code1 = """
        package com.duanxr.mhithrha.test.runtime;
        ...
        """;
    String className1 = "com.duanxr.mhithrha.test.runtime.BunchCompileWithDependencyTest%s";
    try {
      final int count = 101;
      List<JavaSourceCode> list = new ArrayList<>(count);
      ...
      Class<?> test100 = compile.get(
          "com.duanxr.mhithrha.test.runtime.BunchCompileWithDependencyTest100");
  ...
  public void testBunchCompileWithDependencyLoop() {
    String code = """
        ...
        """;
    String className = "com.duanxr.mhithrha.test.runtime.BunchCompileWithDependencyLoop%s";
    try {
      final int count = 101;
